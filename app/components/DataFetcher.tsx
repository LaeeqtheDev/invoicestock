// app/dashboard/homepage.tsx (or DashboardMainPage.tsx)
"use client";
...
// Define interfaces for the aggregated dashboard data
    ...
    >
      <div className="flex justify-between">
        <div>
          ...
          <p>
            Here is how your <span className="text-green-500">Business</span> is
            doing
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-2xl font-bold">
        {title === "Total Profit" ? `$${value}` : value}
      </p>
    </motion.div>
  );
}
